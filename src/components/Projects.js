            ...
            >
              <Card className="project-card">
                ...
                <Card.Body>
                  ...
                  <Card.Text className="project-card-text font-weight-300">
                    Full stack travel/social media web application developed in a
                    team of eight during my third year at University.
                  </Card.Text>
                </Card.Body>
              </Card>
            </a>
              ...
              <Card className="project-card">
                ...
                <Card.Body>
                  ...
                  <Card.Text className="project-card-text font-weight-300">
                    ...
                    displays relevant statistics/news about the COVID-19 virus in
                    your country.
                  </Card.Text>
                </Card.Body>
              </Card>
