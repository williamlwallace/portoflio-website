  ...
  return (
    <div id="projects" className="section">
      ...
      <div className="project-card-deck">
        ...
        {ProjectCard(props, "/images/pocketchef.PNG", "rogur", "rogur is a clone of the Uber app built using a MERN stack", "React Native • Redux • Express • MongoDB", "https://github.com/williamlwallace/rogur")}      
