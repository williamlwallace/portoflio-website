    ...
    <div id="about" className="section">
      ...
      <div className="about-card">
        <p className="about-description">
          I am a graduate Software Engineer (w/ Honours) from the University of Canterbury. My passion is full stack development. I enjoy creating fluid, reactive and user-friendly applications. In my free time you will either find me working on side projects, gaming with friends or loading up plates at the gym{" "}
